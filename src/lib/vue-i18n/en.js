export default {
  ...
  EMAIL不能为空: 'Email cannot be empty',
  ...
  请输入员工名称: 'Please enter the employee name',
  请输入员工组名称: 'Please enter the employee group name',
  退款金额不能大于申请金额:
    'The refund amount cannot be greater than the application amount',
  请输入备注: 'Please enter comments',
  请输入结算密码: 'Please enter the checkout password',
  请再一次输入结算密码: 'Please enter the checkout  password again',
  '中文、英文、荷兰语为必填项': 'Chinese, English and Dutch are required',
  请选择商品分类: 'Please select a product category',
  请选择分类标签: 'Please select a product type',
  ...
  营销管理: 'Marketing',
  折扣促销: 'Promotion',
  添加折扣促销: 'Add Discount Promotion',
  编辑折扣促销: 'Edit Discount Promotion',
  活动名称: 'Activity Name',
  开始时间: 'Start Time',
  失效: 'Invalid',
  导出数据: 'Export Data',
  促销名称: 'Promotion Name',
  促销商品: 'Promotional Products',
  请选择促销商品: 'Please select promotional products',
  批量上传: 'Batch Upload',
  下载模板: 'Download Template',
  上传模板: 'Upload Template',
  折扣率: 'Discount Rate',
  促销价格: 'Promotion Price',
  选择开始时间: 'Select Start Time',
  选择结束时间: 'Select End Time',
  N件N折: 'N-piece N-fold',
  添加N件N折: 'Add N-piece N-fold',
  ...
  组合数量: 'Combination Quantity',
  '您确认要失效此活动吗？': 'Are you sure you want to invalidate this activity？',
  导入促销商品: 'Import Products',
  折扣类型: 'Discount Type',
  统一折扣: 'Unified Discount',
  单个折扣: 'Single Discount',
  请输入折扣率: ' Please enter the discount rate',
  未开始: 'Unstarted',
  已开始: 'Processing',
  已结束: 'Ended',
  已失效: 'Expired',
