    ...
    <div class="info-top">
      ...
      <div class="form-content">
        <el-form
          ...
          <el-row :gutter="20">
            <el-col :span="6">
              <el-form-item label="可售库存:" prop="name">
                <el-input v-model="form.name"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8" :offset="6">
          ...
          <el-row :gutter="20">
            <el-col :span="6">
              <el-form-item label="价格/KG:" prop="name">
                <el-input v-model="form.name"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8" :offset="6">
              <el-form-item label="BBD:" prop="name">
                <el-select v-model="form.name" placeholder="请选择分类">
                  <el-option label="区域一" value="shanghai"></el-option>
                  <el-option label="区域二" value="beijing"></el-option>
                </el-select>
          ...
          <el-row :gutter="20">
            <el-col :span="6">
              <el-form-item label="是否有会员价格:" prop="name">
          ...
          <el-row :gutter="20">
            <el-col :span="6">
              <el-form-item label="会员价格/KG:" prop="name">
                <el-input v-model="form.name"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
